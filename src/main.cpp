...
// configuration step. It creates a namespace called `GettingARound`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        GettingARound::cmake::project_name,
        GettingARound::cmake::project_version));// version string, acquired
